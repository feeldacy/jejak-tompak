...
export default function PrawiraTaniPage() {
  ...
  return (
    <>
      <SEO
        title="Prawira Tani"
        description="Prawira Tani — usaha pembibitan dan budidaya kakao yang bergerak di Desa Giripurwo, Kulon Progo. Berani berinovasi untuk pertanian berkelanjutan."
        path="/prawiratani"
        image={prawiraheader}
      />
      <script
        ...
        <div className="max-w-none text-tompak-green-deep/80 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              Prawira Tani merupakan usaha yang bergerak di bidang pembibitan
              dan budidaya kakao yang berlokasi di Desa Giripurwo, Kabupaten
              Kulon Progo. Nama Prawira memiliki arti berani, sedangkan Tani
              berarti bertani. Filosofi tersebut menggambarkan semangat untuk
              terus berinovasi dan berani mengembangkan sektor pertanian,
              khususnya komoditas kakao.
            </p>
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              ...
              Selain membudidayakan kakao, Prawira Tani juga mengolah hasil
              panen menjadi produk bernilai tambah dengan merek Tompak Cocoa,
              sehingga mampu meningkatkan nilai ekonomi hasil pertanian
              masyarakat.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              ...
              penguatan kapasitas petani yang mandiri serta modernisasi
              ekosistem bisnis pertanian yang berkelanjutan. Visi ini menjadi
              landasan dalam setiap kegiatan yang dilakukan Prawira Tani untuk
              menciptakan pertanian yang produktif, berdaya saing, dan
          ...
          <section className="space-y-4">
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              Prawira Tani memiliki tujuan untuk meningkatkan kesejahteraan
              petani melalui pengembangan budidaya kakao yang berkelanjutan.
              Selain menghasilkan produk kakao yang berkualitas, usaha ini juga
              berupaya memberdayakan masyarakat serta menjaga kelestarian
              lingkungan agar manfaatnya dapat dirasakan dalam jangka panjang.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              Sebagai mitra petani, Prawira Tani berperan dalam menyediakan
              bibit kakao unggul yang berkualitas, memberikan pendampingan mulai
              dari proses budidaya hingga pascapanen, serta mengembangkan
              kemitraan di bidang agroindustri. Di samping itu, Prawira Tani
              juga mengolah hasil panen menjadi produk Tompak Cocoa dan
              menyelenggarakan berbagai kegiatan pelatihan untuk meningkatkan
              kapasitas petani serta masyarakat sekitar.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              ...
              bibit kakao unggul, pendampingan budidaya kakao dari tahap
              penanaman hingga pascapanen, pengolahan hasil kakao menjadi produk
              bernilai tambah, penyelenggaraan pelatihan pertanian
              berkelanjutan, serta pengembangan kemitraan dan edukasi mengenai
              budidaya kakao.
            </p>
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
          ...
          <section className="space-y-4">
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              ...
              mengubah buah kakao menjadi produk yang memiliki nilai tambah,
              salah satunya dark chocolate. Proses ini dimulai sejak tahap
              pembibitan dan penanaman hingga pengolahan pascapanen. Setiap
              tahapan memiliki peran penting dalam menentukan kualitas biji
              kakao yang nantinya akan diolah menjadi produk cokelat
              berkualitas.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              Tahap penanaman menjadi fondasi utama dalam budidaya kakao.
              Tanaman yang berasal dari bibit berkualitas akan menghasilkan buah
              dengan produktivitas dan mutu yang lebih baik. Oleh karena itu,
              proses pembibitan dilakukan dengan beberapa metode sesuai
              kebutuhan dan tujuan budidaya.
            </p>
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              <strong>Pembibitan Generatif</strong> dilakukan dengan menyemai
              biji kakao yang berasal dari buah yang matang dan sehat ke dalam
              media tanam hingga tumbuh menjadi bibit baru.
            </p>
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              Sementara itu, <strong>Pembibitan Vegetatif</strong> dilakukan
              untuk mempertahankan sifat unggul dari tanaman induk melalui
              beberapa teknik, yaitu:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-base md:text-[1.05rem] leading-relaxed marker:text-tompak-green-mid">
              <li>
                <strong>Okulasi</strong>, yaitu menempelkan mata tunas dari
                tanaman kakao unggul pada batang bawah bibit muda hasil
                pembibitan generatif. Teknik ini bertujuan memperoleh tanaman
                unggul dalam waktu yang relatif lebih singkat.
              </li>
              <li>
                <strong>Sambung Pucuk (Grafting)</strong>, yaitu menyambungkan
                batang bawah dari bibit generatif dengan batang atas (entres)
                yang berasal dari pohon induk unggul. Cara ini dilakukan agar
                tanaman baru mewarisi karakter unggul dari induknya.
              </li>
              <li>
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              ...
              memilih bahan tanam yang sehat dan memiliki kualitas baik.
              Pemilihan benih yang tepat akan sangat memengaruhi pertumbuhan
              tanaman di masa mendatang.
            </p>
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              ...
              yang optimal. Media tanam, kelembapan, serta intensitas cahaya
              perlu diperhatikan agar bibit dapat berkembang dengan baik.
            </p>
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              ...
              pemupukan, dan pengendalian hama maupun penyakit hingga bibit
              cukup kuat untuk dipindahkan ke lahan budidaya.
            </p>
            ...
            <p className="leading-[1.85] text-base md:text-[1.05rem]">
              Bibit yang telah memenuhi syarat pertumbuhan kemudian dipindahkan
              ke lahan tanam permanen. Tahap ini dilakukan dengan hati-hati agar
              akar tanaman tidak mengalami kerusakan sehingga tanaman dapat
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2 text-base md:text-[1.05rem] leading-relaxed marker:text-tompak-green-mid">
              ...
              <li>
                <strong>Sortasi dan Pemecahan Buah</strong>, untuk memisahkan
                biji kakao dari kulit buah sekaligus memilih biji yang
                berkualitas.
              </li>
              <li>
              ...
              <li>
                <strong>Penjemuran</strong>, dilakukan untuk menurunkan kadar
                air hingga biji siap disimpan.
              </li>
              <li>
