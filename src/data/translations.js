// Translations for the main page only.
// Keys are grouped by section for maintainability.
export const translations = {
  ID: {
    nav: {
      beranda: "Beranda",
      tentang: "Tentang Tompak",
      sejarah: "Sejarah",
      komoditas: "Komoditas",
      prawira: "Prawira Tani",
      artikel: "Artikel",
    ...
    sejarah: {
      ...
      acronym: [
        ...
        { letter: "O", word: "Obah" },
        { letter: "M", word: "Makaryo" },
        { letter: "P", word: "Pakarti" },
        { letter: "A", word: "Amrih" },
    ...
    artikel: {
      ...
      description:
        "Cerita, refleksi, dan catatan perjalanan dari tanah Tompak.",
      readMore: "Baca selengkapnya",
    },
    dokumentasi: {
      title: "Dokumentasi Visual",
      description: "Sekilas pandang tentang keindahan tanah Tompak.",
    },
    footer: {
      tagline: "Menelusuri jejak, merawat warisan.",
      quickLinks: "Tautan Cepat",
      contact: "Kontak",
      follow: "Ikuti Kami",
      rights: "© 2024 Jejak Tompak. Hak cipta dilindungi.",
    },
  },
  EN: {
    nav: {
      beranda: "Home",
      tentang: "About Tompak",
      sejarah: "History",
    ...
    sejarah: {
      eyebrow: "History",
      title: "The History of Tompak Village",
      motto: '"Topong Rame" — Whoever Faces Hardship Must Be Helped',
      caption: "The Menoreh Highlands & Watu Tompak",
      acronym: [
        { letter: "T", word: "Trengginas (Agile)" },
        { letter: "O", word: "Obah (Moving)" },
        { letter: "M", word: "Makaryo (Working)" },
        { letter: "P", word: "Pakarti (Virtue)" },
        { letter: "A", word: "Amrih (To Strive)" },
    ...
    artikel: {
      ...
      description:
        "Stories, reflections, and travel notes from the land of Tompak.",
      readMore: "Read more",
    },
    dokumentasi: {
      title: "Visual Documentation",
      description: "A glimpse into the beauty of the land of Tompak.",
    },
    footer: {
      tagline: "Tracing footprints, preserving heritage.",
      quickLinks: "Quick Links",
      contact: "Contact",
      follow: "Follow Us",
      rights: "© 2024 Jejak Tompak. All rights reserved.",
    },
  },
};

export const getT = (language) => translations[language] || translations.ID;
